...
const Testimonial = () => (
  <section className="relative min-h-[70vh] w-full flex items-center justify-center p-8 md:p-24 overflow-hidden bg-black text-white">
    ...
    <div className="relative z-10 text-center max-w-5xl">
       <h2 className="text-3xl md:text-6xl font-light font-serif leading-tight tracking-tight mb-20 italic">
        "The level of discretion and attention to detail is simply unmatched. A true asset for the discerning traveler."
       </h2>
